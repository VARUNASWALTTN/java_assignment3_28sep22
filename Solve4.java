...
public class Solve4{
    public static void main(String[] args){
        Employee1 e1 = new Employee1("varun ","SE",22);
        Employee1 e2 = new Employee1("varun 2","SE2",23);
        Employee1 e3 = new Employee1("varun 3","SE3",24);
        Employee1 e4 = new Employee1("varun 4","SE4",25);
